...
This tutorial will demonstrate how to develop a Python program using Selenium and BeautifulSoup to extract data from the [Opta Player Stats](https://optaplayerstats.statsperform.com) statistics platform.
...
By using this program, it was possible to create a dataset with the data from all matches of the Brasileirão from 2020 to 2023, which can be found at this link on [Kaggle](https://www.kaggle.com/).
